...
final readonly class DemoteRankCommandHandler
    implements CommandHandlerInterface
{
    ...
    public function __invoke(DemoteRankCommand $command): ChatClientResultDTO
    {
        try {
            ...
            $target->rankDemote($command->getDemoteRanksValue());
